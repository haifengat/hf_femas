...
def run(generate_c: bool, generate_py: bool, generate_cs: bool = True):
    f_src = open(os.path.join(cur_dir, src_dir, f'{file_src}.h'), 'r', encoding='utf-8')
...
#ifdef WIN32
#define WINAPI      __cdecl
#include "win32/{file_src}.h"
#pragma comment(lib, "win32/{lib_name}.lib")
#else
#define WINAPI      __stdcall
#include "win64/{file_src}.h"
#pragma comment(lib, "win64/{lib_name}64.lib")
#endif
#else
#define WINAPI
#include "lnx64/{file_src}.h"
#endif
    ...
    {{
        ...
        {{
            ...
            return pRspInfo;
                ...
                f_c_cpp.write(f'''#include "{spi_class_name}.h"
#include <string.h>
int nReq;
...
if __name__ == '__main__':
    src_dir = '../lnx64'
    spi_class_name = 'trade'
    file_src = 'USTPFtdcTraderApi'
    lib_name = 'USTPtraderapiAF'
    api_class_name = 'CUstpFtdcTraderApi'
    info_struct_name = 'CUstpFtdcRspInfoField'
    create_api = 'CUstpFtdcTraderApi::CreateFtdcTraderApi'
    run(True, True)
    # run(False, True)
    spi_class_name = 'quote'
    file_src = 'USTPFtdcMduserApi'
    lib_name = 'USTPmduserapiAF'   # 看穿式监管
    api_class_name = 'CUstpFtdcMduserApi'
    info_struct_name = 'CUstpFtdcRspInfoField'
    create_api = 'CUstpFtdcMduserApi::CreateFtdcMduserApi'
    run(True, True)
    # run(False, True)
